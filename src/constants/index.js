import {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'An AI powered web application that allows users to generate cover letters for their job applications. It also allows users to upload their resumes and generate cover letters based on their resumes and job description they are applying for.',
      tags: [
        {
          name: "React",
          color: "blue-text-gradient",
    ...
    },
    {
      ...
      image: mpd,
      sourceCodeLink: "https://github.com/DanishAqib/missing-person-detection-system",
      websiteLink: ""
    },
    {
      name: "Movie Theatre",
  ...
  const contactLinks = [
    {
      name: "LinkedIn",
      icon: linkedin,
      url: "https://www.linkedin.com/in/danishaqib"
    },
    {
      name: "GitHub",
      icon: github,
      url: "https://github.com/DanishAqib"
    },
    {
      name: "Facebook",
      icon: facebook,
      url: "https://www.facebook.com/danish.aaquib"
    },
    {
      name: "Twitter",
      icon: twitter,
      url: "https://twitter.com/danish_aqib"
    },
    {
      name: "Instagram",
      icon: instagram,
      url: "https://www.instagram.com/danish_aqib"
    }
  ]
